...
const TERMINAL_LINES = [
  ...
  { text: "ü¶û Robin v1.0 ‚Äî Unfettered AI Partner", delay: 600, color: "text-orange-400 font-bold" },
  { text: "  ‚úì Voice mode enabled", delay: 1200, color: "text-green-400" },
  { text: "  ‚úì Agent team spawned (3 agents)", delay: 1700, color: "text-green-400" },
  { text: "  ‚úì All 56 features unlocked", delay: 2200, color: "text-green-400" },
  { text: "  ‚úì Connected to OpenRouter API", delay: 2700, color: "text-green-400" },
  { text: "", delay: 3200, color: "" },
  { text: "‚-Ü Waiting for task...", delay: 3400, color: "text-orange-200" },
  { text: "> Refactor auth module, add OAuth2, write tests", delay: 4000, color: "text-white" },
  { text: "", delay: 4400, color: "" },
  { text: "‚-Ü Dispatching to agent team...", delay: 4600, color: "text-orange-300" },
];

// Agent chat messages
const AGENT_MESSAGES = [
  { agent: "Architect", color: "#f97316", icon: "üè-", msg: "Analysing auth module structure...", delay: 5200 },
  { agent: "Developer", color: "#fb923c", icon: "üíª", msg: "Found 3 auth patterns. Proposing OAuth2 flow.", delay: 6000 },
  { agent: "Tester", color: "#fdba74", icon: "üß™", msg: "Generating test suite for new flows.", delay: 6800 },
  { agent: "Architect", color: "#f97316", icon: "üè-", msg: "Auth module refactored. 847 lines ‚Üí 312 lines.", delay: 7800 },
  { agent: "Developer", color: "#fb923c", icon: "üíª", msg: "OAuth2 + refresh tokens implemented ‚úì", delay: 8600 },
  { agent: "Tester", color: "#fdba74", icon: "üß™", msg: "42 tests passing. Coverage: 97% ‚úì", delay: 9400 },
  { agent: "Robin", color: "#ea580c", icon: "ü¶û", msg: "Done. Task complete in 38 seconds.", delay: 10200 },
];
    ...
    <div className="rounded-xl overflow-hidden shadow-2xl border border-orange-900/30" style={{ background: "#1a0f08" }}>
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-orange-900/30" style={{ background: "#120b05" }}>
        <div className="flex items-center gap-2">
          ...
          <span className="w-4 h-4 rounded bg-orange-500/80 text-white flex items-center justify-center text-[9px] font-black">R</span>
          <span className="text-xs text-orange-400 font-mono font-semibold">Agent Team ‚Äî Live</span>
        </span>
        </div>
