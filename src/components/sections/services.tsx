...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    titleNL: "Rapportage & Compliance",
    titleEN: "Reporting & Compliance",
    subtitleNL: "Power BI, audit trails, BTW-aangiftes, interne controle",
    subtitleEN: "Power BI, audit trails, VAT returns, internal control",
    agents: [
      { id: "management-rapportage", titleNL: "Management Rapportage Agent", titleEN: "Management Reporting Agent", descNL: "Haalt data op uit Dynamics/SAP, bouwt wekelijkse P&L en KPI-dashboards en distribueert ze automatisch naar de juiste ontvangers.", descEN: "Pulls data from Dynamics/SAP, builds weekly P&L and KPI dashboards and automatically distributes them to the right recipients.", complexity: "high", priceRange: [12000, 22000], avgTimeSavedHoursWeek: 18, avgROIPercent: 310, toolsNL: "Power BI, Dynamics F&O, SAP, Teams, Outlook", toolsEN: "Power BI, Dynamics F&O, SAP, Teams, Outlook" },
      { id: "btw-aangifte", titleNL: "BTW Aangifte Agent", titleEN: "VAT Return Agent", descNL: "Verzamelt transactiedata, controleert BTW-codes, reconcilieert met grootboek en exporteert aangifte-ready bestanden voor de belastingadviseur.", descEN: "Collects transaction data, validates VAT codes, reconciles with GL and exports return-ready files for the tax adviser.", complexity: "high", priceRange: [10000, 20000], avgTimeSavedHoursWeek: 15, avgROIPercent: 350, toolsNL: "Dynamics F&O, SAP, Excel API, Belastingdienst API", toolsEN: "Dynamics F&O, SAP, Excel API, Tax Authority API" },
      { id: "interne-controle", titleNL: "Interne Controle Agent", titleEN: "Internal Control Agent", descNL: "Monitort transacties op segregation-of-duties schendingen, ongebruikelijke bedragen en procesafwijkingen. Genereert auditwaardige logs.", descEN: "Monitors transactions for segregation-of-duties violations, unusual amounts and process deviations. Generates audit-ready logs.", complexity: "enterprise", priceRange: [20000, 40000], avgTimeSavedHoursWeek: 20, avgROIPercent: 320, toolsNL: "Dynamics F&O, SAP GRC, Power BI, SharePoint", toolsEN: "Dynamics F&O, SAP GRC, Power BI, SharePoint" },
      { id: "intercompany", titleNL: "Intercompany Reconciliatie Agent", titleEN: "Intercompany Reconciliation Agent", descNL: "Matcht intercompany-boekingen tussen entiteiten automatisch, detecteert open posten en genereert elimiatievoorstellen voor de consolidatie.", descEN: "Automatically matches intercompany postings between entities, detects open items and generates elimination proposals for consolidation.", complexity: "enterprise", priceRange: [18000, 35000], avgTimeSavedHoursWeek: 25, avgROIPercent: 360, toolsNL: "Dynamics F&O, SAP S/4HANA, Power BI, Excel API", toolsEN: "Dynamics F&O, SAP S/4HANA, Power BI, Excel API" },
    ],
  },
];
